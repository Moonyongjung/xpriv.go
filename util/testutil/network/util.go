...
import (
	...
	xtypes "github.com/Moonyongjung/xpriv.go/types"
...
func startInProcess(cfg Config, val *Validator) error {
	...
	if val.AppConfig.JSONRPC.Enable && val.AppConfig.JSONRPC.Address != "" {
		...
		val.jsonrpc, val.jsonrpcDone, err = serve.StartJSONRPC(val.Ctx, val.ClientCtx, tmRPCAddr, tmEndpoint, val.AppConfig, nil)
		if err != nil {
			return err
		}
